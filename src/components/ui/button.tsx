...
export function Button({
  ...
  const variantStyles = {
    ...
    secondary:
      'bg-zinc-200 text-zinc-900 hover:bg-zinc-300 active:bg-zinc-400 focus:ring-zinc-500 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700 dark:active:bg-zinc-600',
    danger:
